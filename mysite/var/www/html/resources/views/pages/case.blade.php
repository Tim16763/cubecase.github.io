...
<div class="profile-button--hover"></div><a class="profile-button__text" href="#">Забрать приз</a>
    ...
    <div class="ceys_full full" data-name="{{$case->name}}" data-id="{{$case->id}}">
        <div class="hidden">
            <div class="ceys_title" style="color:#eccb6b;text-shadow: 0 0 30px rgb(164, 100, 19);">{{$case->name}}</div>
        </div>
        <div class="rulet_full full">
            ...
            <div class="rulet_btn" id="button_buy">
                <span>ИСПЫТАТЬ УДАЧУ</span> <b data-cost="{{$case->price}}" id="container-cost">{{$case->price}} руб.</b>
            </div>
            <div class="rulet">
                <ul>
