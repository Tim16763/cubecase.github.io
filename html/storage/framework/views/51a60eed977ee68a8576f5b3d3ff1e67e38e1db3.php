...
<head>
    ...
    <meta property="og:image" content="https://<?php echo e($config->namesite); ?>/images/banner.png"/>
    <meta property="og:url" content="https://<?php echo e($config->namesite); ?>/"/>
            ...
            <?php else: ?>
                <div class="panel">
                    <div class="mini_profile">
                        <div class="mini_profile_ava"><a href="/account/"><img src="<?php echo e($u->avatar); ?>" alt=""/></a></div>
                        <div class="hidden">
                            <div class="mini_profile_login ell"><a href="/account/" style="color:#fff;"><?php echo e($u->name); ?></a>
                            </div>
                            <div class="mini_profile_balance left">
                                Баланс: <b id="balanceuser"><?php echo e($u->balance); ?> Руб.</b>
                            </div>
                    ...
                    <div class="header-nav">
                        <a href="<?php echo e($config->vkgroup); ?>" target="_blank" class="btn-header btn-vk">Мы ВКонтакте</a>
                        <a href="https://<?php echo e($config->namesite); ?>/account/?=ref" class="btn-header btn-open-free">Открывай бесплатно!</a>
                    </div>
                </div>
            <?php endif; ?>
            <div class="nav">
                <ul>
                    ...
                    <li><a href="<?php echo e($config->vkgroup); ?>" target="_blank">Конкурсы и раздачи</a></li>
                    <?php if(Auth::guest()): ?>
                    <?php endif; ?>
                </ul>
            </div>
