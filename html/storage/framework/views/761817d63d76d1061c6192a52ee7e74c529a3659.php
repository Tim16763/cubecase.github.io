...
<head>
    ...
    <script src="/adminAsset/js/materialize.js"></script>
    <meta charset="utf-8">
    ...
    <script src="/adminAsset/plugins/morris/morris.js"></script>
    ...
    <div class="topbar">
        ...
        <div class="topbar-left">
            <div class="text-center">
                <a href="/admin" class="logo"><i class="icon-magnet icon-c-logo"></i><span>Storegamer.ru</span></a>
            </div>
        </div>
                    ...
                    <ul class="nav navbar-nav navbar-right pull-right">
                        <li class="dropdown top-menu-item-xs">
                            <a href="" class="dropdown-toggle profile waves-effect waves-light" data-toggle="dropdown"
                               aria-expanded="true"><img src="<?php echo e($u->avatar); ?>" alt="user-img"
                                                         class="img-circle"> </a>
                        </li>
                    </ul>
                </div>
        ...
        <div class="sidebar-inner slimscrollleft">
            ...
            <div id="sidebar-menu">
                <ul>
					...
					<li class="has_sub ms-hover">
                        <a href="/admin/category" class="waves-effect"><i class="ti-spray"></i> <span> Категории </span> </a>
                    </li>
