...
var que=[];var pending=false;function scrollArray(elem,left,top,delay){delay||(delay=2000);directionCheck(left,top);que.push({x:left,y:top,lastX:(left<0)?0.99:-0.99,lastY:(top<0)?0.99:-0.99,start:+new Date});if(pending){return;}
